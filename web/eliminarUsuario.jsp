        ...
        <div id="dragScriptContainer">
            ...
            <div class="konaBody">
                ...
                <div id="description">
                    ...
                    <p>Aqui podras eliminar un usuario que desees</p>	
                </div>
                <form action="eliminarUsuariosCampos.jsp">
                    <%
                    ...
                    <table>
                        ...
                        <tr>
                            <td><input type="radio" name="username" value="<%out.print(usuarios.get(i).getId());%>" required></td>
