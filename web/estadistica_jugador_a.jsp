    ...
    <body>
        <div id="dragScriptContainer">
            <div class="konaBody">
                <div id="description">
                    <%
                      ResultSet rs = st.executeQuery("select user_name from usuarios where ID = '"+request.getParameter("idd")+"'");
                      rs.next();
                    %>
                    <h1>Estadisticas de usuario</h1>
                    <p>Estas son tus estadisticas en todo el juego</p>
                    <p><%out.print(rs.getString("user_name"));%></p>
                    <p><%out.print(request.getParameter("idd"));%></p>
                    <%
                        rs = st.executeQuery("select * from usuarios_puntajes where ID = '"+request.getParameter("idd")+"'");
                        rs.next();
                    %>
                    <table>
                        <tr>
