        ...
        <div id="dragScriptContainer">
            <div class="konaBody">
                <div id="description">
                    ...
                    <p>Aqui podras buscar las estadisticas de un jugador en especifico</p>
                    <p>Usuarios en el sistema</p>
                    <%
                        Usuarios usuario = new Usuarios();
                        LinkedList<Usuarios_set_get> usuarios = usuario.get_Datos();
                    %>
                    <form action="estadistica_jugador_a.jsp">
                    <table>
                        <tr>
                            <th></th>
                            <th>Cedula</th>
                        ...
                        <% for (int i = 0; i < 2; i++) {%>
                        <tr>
                            <td><input type="radio" name="idd"  value="<%out.print(usuarios.get(i).getId()); %>" required></td>
                    ...
                    <br>
                    <input type="submit" value="Buscar estadisticas">
                </form>
                </div>
